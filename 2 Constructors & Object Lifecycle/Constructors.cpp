...
// ============================================================================
// Experiment 3: Member Object Initialization
// Member objects are initialized BEFORE the constructor body executes.
// Using the initialization list directly constructs the member object.
// ============================================================================
...
public:
    ...
    Address(string city)
        : city(city)
    {
        cout << "Address Constructor Called\n";
    }
...
public:
    ...
    Student(string name, int age)
        : name(name), age(age), address("Bangalore")
    {
...
//         │
//         ▼
// Initialize address   ← Address constructor runs here
//         │
//         ▼
// Enter Student constructor body